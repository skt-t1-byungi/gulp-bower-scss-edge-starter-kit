...
gulp.task('watch', ['sprites', 'bower', 'edge', 'scss', 'js'], () => {
  gulp.watch('src/**/!(_*).edge', ['edge']);
  ...
  gulp.watch('src/**/_*.edge', doWithoutNewer('edge'));
...
gulp.task('dev', () => {
  return $.runSequence('dev:del', ['bower', 'edge', 'scss', 'js']);
});
